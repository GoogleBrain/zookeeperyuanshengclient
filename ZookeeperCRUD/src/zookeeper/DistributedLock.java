...
public class DistributedLock implements Watcher {
			...
			new Thread() {
				...
				public void run() {
					try {
						...
						System.err.println("【第" + threadId + "个线程】 抛出的异常：");
						e.printStackTrace();
					}
				}
			}.start();
	...
	public void getLockSuccess() throws KeeperException, InterruptedException {
		if (zk.exists(this.selfPath, false) == null) {
			System.err.println(LOG_PREFIX_OF_THREAD + "本节点已不在了...");
			return;
		}
	...
	public boolean checkMinPath() throws KeeperException, InterruptedException {
		...
		int index = subNodes
				.indexOf(selfPath.substring(GROUP_PATH.length() + 1));
		switch (index) {
		case -1: {
			System.err.println(LOG_PREFIX_OF_THREAD + "本节点已不在了..." + selfPath);
			return false;
		}
		case 0: {
			System.err.println(LOG_PREFIX_OF_THREAD + "子节点中，我果然是老大" + selfPath);
			return true;
		}
		default: {
